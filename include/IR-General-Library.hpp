...
auto OutputResult(const PathType& FilePath, const HeaderType& Header, const QueriesStemType& QueriesStem, const QueriesDocumentsStemType& QueriesDocumentsOrderedStem)
{
    ...
    auto DocumentsStemSize = std::accumulate(std::begin(QueriesDocumentsOrderedStem), std::end(QueriesDocumentsOrderedStem), std::size_t(0), [](const std::size_t Sum, DocumentsStemConstReferenceType DocumentsStem)
        {
